...
def save_installer(installerdata):
    ...
    downloadpath = r'C:\Users\vlc.exe'
    with open(downloadpath, 'wb') as file:
        file.write(installerdata)    
    return downloadpath

def run_installer(installerpath):
    ...
    #TO DO:Step 5
    subprocess.run([installerpath, '/L=1033', '/S'], shell=True)

def delete_installer(installerpath):
    #TO DO:Step 6
